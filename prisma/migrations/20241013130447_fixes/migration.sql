/*
  ...
  - The `salary` column on the `DeliveryMan` table would be dropped and recreated. This will lead to data loss if there is data in the column.
...
-- AlterTable
ALTER TABLE "DeliveryMan" DROP COLUMN "salary",
